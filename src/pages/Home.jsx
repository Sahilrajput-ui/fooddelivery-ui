...
const Home = ({ input }) => {
  ...
  return (
    <div className="bg-slate-200 w-full min-h-screen">
      ...
      {input ? (
        ...
        justify-start text-[20px] font-semibold text-gray-600 rounded-lg shadow-xl hover:bg-green-200 
  ...
  <div className="text-center text-2xl text-green-500 font-semibold pt-5 ">No dish found</div>
      ...
      <div
        className={`w-full md:w-[40vw] h-[100%] fixed top-0 right-0 bg-white shadow-xl p-6 transition-all duration-500 flex flex-col items-center overflow-auto ${showCart ? "translate-x-0" : "translate-x-full"}`}
      >
        ...
        <div
          className="w-full border-t-2 border-b-2 border-gray-400 mt-7
